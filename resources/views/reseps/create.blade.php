...
<body class="bg-gray-100 text-gray-900">
    <div class="container mx-auto p-6 max-w-lg">
        ...
        <form action="{{ route('reseps.store') }}" method="POST" enctype="multipart/form-data"
            ...
            <button type="submit"
                class="w-full bg-blue-500 text-white p-3 rounded-lg shadow hover:bg-blue-600 transition">Simpan</button>
        </form>
        <a href="{{ route('home') }}" class="block text-center text-blue-500 mt-4 hover:underline">Kembali ke Halaman
            Utama</a>
    </div>
