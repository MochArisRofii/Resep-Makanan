    ...
    <div class="container mx-auto p-6 max-w-lg">
        ...
        <form action="{{ route('reseps.update', $resep->id) }}" method="POST" enctype="multipart/form-data"
            ...
            <div class="mb-4">
                ...
                <input type="text" id="name" name="name" value="{{ old('name', $resep->name) }}"
                    class="w-full mt-1 border border-gray-300 p-2 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                    required>
                @error('name')
            ...
            <div class="mb-4">
                ...
                <textarea id="deskripsi" name="deskripsi"
                    class="w-full mt-1 border border-gray-300 p-2 
                rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">{{ old('deskripsi', $resep->deskripsi) }}</textarea>
                @error('deskripsi')
                    <div class="text-red-500 mt-1 text-sm">{{ $message }}</div>
                @enderror
            </div>
                ...
                <div class="mb-4">
                    ...
                    @if ($resep->photo)
                        ...
                        max-w-xs h-auto object-cover rounded-md shadow-md mx-auto">
                    @endif
                ...
                shadow hover:bg-blue-600 transition">Simpan
                    Perubahan</button>
        </form>
    </div>
</body>
