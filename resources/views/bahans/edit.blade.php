...
<body class="bg-gray-50 text-gray-800">
    ...
    <nav class="bg-blue-600 text-white p-4 shadow-md">
        <div class="container mx-auto flex justify-between items-center">
            ...
            <div class="space-x-4">
                <a href="{{ route('reseps.show', $bahan->resep_id) }}" class="bg-blue-500 text-white px-4 py-2 
                    rounded-lg shadow hover:bg-blue-600 transition">Kembali ke Detail Resep</a>
            </div>
        </div>
    </nav>
        ...
        <div class="bg-white rounded-lg shadow-lg p-6">
            ...
            <form action="{{ route('bahans.update', $bahan->id) }}" method="POST" class="space-y-6">
                ...
                <div class="space-y-2">
                    ...
                    <textarea name="deskripsi" id="deskripsi" required class="w-full px-3 py-2 border border-gray-300 
                    rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500">{{ $bahan->deskripsi }}</textarea>
                </div>
                <div class="space-y-2">
                ...
                <div class="space-y-2">
                    ...
                    <select name="resep_id" id="resep_id" required class="w-full px-3 py-2 
                ...
                shadow hover:bg-blue-700 transition w-full">Update Bahan</button>
            </form>
        </div>
    </div>
</body>
